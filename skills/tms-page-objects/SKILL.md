---
name: tms-page-objects
description: >
  Page Object Model structure and patterns for ALL TMS modules.
  Generic template applicable to Contratos, Viajes, Reportes, and future modules.
  Trigger: Creating ANY new Page Object, organizing test code, refactoring Page Object methods.
license: MIT
metadata:
  author: QA Team
  version: "1.0.0"
  scope: [root, src/pages, tests]
  auto_invoke: "Creating new Page Object for any TMS module, Adding new module to framework, Organizing test code, Refactoring Page Object methods"
  last_updated: "2025-01-30"
  status: active
  category: testing
  tags: [page-object-model, architecture, tms, generic-pattern]
