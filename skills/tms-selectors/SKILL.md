...
name: tms-selectors
description: >
  TMS selector database integration and priority rules for ALL modules.
  Generic patterns for finding stable selectors across Contratos, Viajes, Reportes, etc.
  Trigger: Selecting ANY element in ANY TMS page, creating Page Objects, debugging selector issues.
license: MIT
metadata:
  author: QA Team
  version: "1.1.0"
  ...
  status: active
  category: testing
  tags: [selectors, confluence, playwright, anti-hallucination, generic-pattern]
