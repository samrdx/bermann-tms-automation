...
name: tms-dropdowns
description: >
  Bootstrap Select dropdown automation patterns for TMS.
  Generic patterns applicable to ALL TMS modules.
  Trigger: Working with ANY dropdown, cascading dropdowns, date pickers, or select elements across TMS.
license: MIT
metadata:
  author: QA Team
  version: "1.1.0"
  ...
  status: active
  category: testing
  tags: [bootstrap, dropdowns, selectors, tms, ui-automation, generic-pattern]
