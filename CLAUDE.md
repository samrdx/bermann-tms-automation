...
### ✅ Completed
1. **Login/Logout** - LoginPage, DashboardPage
2. **Contratos** - ContratosFormPage (complex dropdowns, cascading)

### 🎯 In Progress
3. **Planificar Viajes** - PlanificarViajesPage
4. **Asignar Viajes** - AsignarViajesPage
