...
import { CapacidadPage } from '../modules/transport/pages/CapacidadPage.js';
...
export const test = base.extend<MyFixtures>({
  ...
  capacidadPage: async ({ page }, use) => {
    await use(new CapacidadPage(page));
  },
